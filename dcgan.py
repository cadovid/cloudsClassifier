...
semeion_x = np.load("searchedClass.npy")
semeion_y = np.load("ValuesClass.npy")
...
train_dl = DataLoader(train_ds, batch_size=opt.batch_size, shuffle=True)
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(train_dl):
        ...
        print(
            ...
            % (epoch, opt.n_epochs, i, len(train_dl), d_loss.item(), g_loss.item())
        )
