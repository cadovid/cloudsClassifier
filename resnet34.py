...
val_loader = DataLoader(validation_ds, batch_size=len(validation_ds), shuffle=False)
...
# get resnet34 model with 3 channels
...
print(f'test_predict: {test_preds}')